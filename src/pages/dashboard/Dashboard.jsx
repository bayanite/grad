...
// //     const pieData = [
// //         {name: data && data[0] && data[0].name, value: certificatePercentage},
// //         {name: 'Other', value: 100 - certificatePercentage},
// //     ];
// //
// //     const COLORS = ['#00C49F', '#FFBB28'];
// //     const legendContent = (
...
// // const DashboardPage = () => {
// //     const [countData, setCountData] = useState(null);
// //     const [pieChartData, setPieChartData] = useState(null);  // Set initial state to null
// //     const [appointmentData, setAppointmentData] = useState(null);  // Set initial state to null
// //     const [statisticsData, setStatisticsData] = useState(null);  // Set initial state to null
// //     const [loading, setLoading] = useState(true);
...
// //                             </div>
// //                             <div className={"CustomPieChart_container"}>
// //                                 {pieChartData && pieChartData.data1 && (
// //                                     <CustomPieChart data={pieChartData.data1}/>
// //                                 )}
// //                                 {pieChartData && pieChartData.data2 && (
// //                                     <CustomPieChart data={pieChartData.data2}/>
// //                                 )}
// //                             </div>
// //                         </div>
...
// //                                         </div>
// //                                         <div
// //                                             className="time-app">{formatTime(appointment.from)} - {formatTime(appointment.to)}</div>
// //                                     </li>
// //                                 ))}
// //                             </ul>
// //                         ) : (
